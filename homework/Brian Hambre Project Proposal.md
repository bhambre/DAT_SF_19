...
I plan on using a dataset which includes # of support reps, # of calls taken, location of reps, dropped calls, total calls, and service level/day.  

Currently, the data I have are all in emails but I’m trying to get direct access to the data source itself.  The amount of data I have currently is 3 months’ worth of support data.
